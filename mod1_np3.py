def main():
    ...
    with open("meu_arquivo.txt", "r") as arquivo:
        for linha in arquivo:
            dados_modificados.append(linha.strip().upper()) #Exmplo de Manipulação: converter para maiúscula toda a frase

    with open("meu_arquivo.txt", "w", encoding="utf-8") as arquivo:
        for linha in dados_modificados:
            arquivo.write(linha + "\n")
    print("O arquivo foi subescrito com os dados modificados.") 
